...
|----------|--------------------------|-----------------------|-----------------------|----------------|-----------------------------|--------|--------------|
| **Conecta** | [conecta-api](https://github.com/Atom-Smart-Chains/conecta-api) (AdonisJS) | `conecta-frontend` (Angular) | `conecta-admin` (Angular) | PostgreSQL | Polygon (Solidity) | Ativo  | v4/5 (prod.) |
